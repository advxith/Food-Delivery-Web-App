...
function Reset() {
    ...
    const formik = useFormik({
        ...
        onSubmit: (data, { resetForm }) => {
            ...
            toast.success("Password reset successfully. You will be redirected to the login page shortly.");
            setTimeout(() => {
                navigate("/login");
            }, 5000);
        },
            ...
            <div className='fourth'>
                <Grid container>
                    ...
                    <Grid item xs={12}>
                        ...
                        <h1 style={{ fontFamily: 'timesnewroman', color: 'black', textAlign: 'center', fontSize: 35 }}><b>Reset your password</b></h1>
                    </Grid>
                    <Grid item xs={12}>
                        <br />
                    </Grid>
                    ...
                    <Grid item xs={12} sx={{ justifyContent: 'center', display: 'flex' }}>
                        {isFormSubmitted ? '' : <Button variant='contained' sx={{ textTransform: 'none', fontFamily: 'timesnewroman', backgroundColor: 'black', color: 'yellow', fontSize: 15 }} onClick={() => formik.handleSubmit()}><b>Reset Password</b></Button>}
                    </Grid>
                    <Grid item xs={12}>
                        <br />
                    </Grid>
